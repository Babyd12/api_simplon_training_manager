...
return [
    ...
    [ // $dynamicRoutes
        ...
        259 => [[['_route' => '_api_/formations/{id}{._format}_get', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Formation', '_api_operation_name' => '_api_/formations/{id}{._format}_get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        282 => [[['_route' => '_api_/formations{._format}_post', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Formation', '_api_operation_name' => '_api_/formations{._format}_post'], ['_format'], ['POST' => 0], null, false, true, null]],
        319 => [
        ...
        363 => [[['_route' => '_api_/roles/{id}{._format}_get', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Role', '_api_operation_name' => '_api_/roles/{id}{._format}_get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        389 => [
        ...
        471 => [[['_route' => '_api_/users/{id}{._format}_get', '_controller' => 'api_platform.symfony.main_controller', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\User', '_api_operation_name' => '_api_/users/{id}{._format}_get'], ['id', '_format'], ['GET' => 0], null, false, true, null]],
        497 => [
